...
const translations = {
  de: {
    ...
    "contact.form.success": "Kontaktanfrage erfolgreich! Wir melden uns schnellstmöglich bei dir.",
  ...
  // Hero
    ...
    "privacy.legalBasis.contract": "Εκτέλε��η σύμβασης (Άρθ. 6 παρ. 1 στ. β GDPR)",
    ...
    "privacy.rights.complaintDesc": "Έχετε το δικαίωμα να υποβάλετε καταγγελί�� σε εποπτική αρχή.",
